...
int main(){
    AES aes;
    string text, key;
    cout << "AES Encryption/Decryption [only up to 16 characters OR HEX representations (32 characters)]\n";
    string choice;
    ...
    if (tolower(choice[0])=='e'){
        ...
        cout << "Enter key: ";
        getline(cin, key);
        cout << "= " << aes.encrypt(text, key) << endl;
    } else {
        cout << "Enter text to decrypt: ";
        getline(cin, text);
        cout << "Enter key: ";
        getline(cin, key);
        cout << "= " << aes.decrypt(text, key) << endl;
    }
}